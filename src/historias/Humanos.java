...
public abstract class Humanos{
    ...
    private static final String EL_GOBLIN_DEL_TUTORIAL_1_1 = "Mientras te estás yendo, lejos de tu mirada, una gran y espesa niebla empieza a engullir al goblin que habías dejado moribundo en el suelo.";
    private static final String EL_GOBLIN_DEL_TUTORIAL_1_2 = "Al esfumarse esa niebla, aparece una pequeña sombra. \"Así que hay un aventurero abusando de mis peones...\"";
    private static final String EL_GOBLIN_DEL_TUTORIAL_1_3 = "Sigues tu camino sin darte cuenta de los problemas que te has buscado, o los que podrías haber esquivado.";

    private static final String EL_GOBLIN_DEL_TUTORIAL_2_1 = "Tu viaje continúa por los páramos solitarios, con la sensación de que algo te observa desde la distancia. \n"
            +
            "Conforme avanzas, el aire se vuelve más pesado y un mal presentimiento se apodera de ti.";
    private static final String EL_GOBLIN_DEL_TUTORIAL_2_2 = "Una noche, al detenerte en una posada en medio del camino, el silencio es interrumpido por un estruendo. \n"
            +
    ...
    private static final String EL_GOBLIN_DEL_TUTORIAL_2_3 = "\"No debiste meterte con nuestro señor...\"";
    private static final String EL_GOBLIN_DEL_TUTORIAL_2_4 = "Sin previo aviso, te ataca con una velocidad inhumana.";
    private static final String EL_GOBLIN_DEL_TUTORIAL_2_4_VICTORIA = "El combate es feroz, obligándote a usar todas tus habilidades para sobrevivir. \n"
            +
            "Finalmente, tras un golpe certero, el goblin cae de rodillas y desaparece en una niebla negra.";
    private static final String EL_GOBLIN_DEL_TUTORIAL_2_4_DERROTA = "Has muerto. \nEl goblin coge tu cuerpo moribundo y lo tira contra la pared, quedando aplastado entre las rendijas de los ladrillos.";
    private static final String EL_GOBLIN_DEL_TUTORIAL_2_5 = "Tras la pelea, decides que es mejor prepararte antes de continuar tu viaje. \n"
            +
    ...
    private static final String EL_GOBLIN_DEL_TUTORIAL_3_1 = "Después de tu tiempo de preparación, sigues tu camino hasta un antiguo santuario en ruinas. \n"
            +
    ...
    private static final String EL_GOBLIN_DEL_TUTORIAL_3_2 = "Una figura encapuchada emerge de las sombras. Sus ropajes están marcados con símbolos extraños, y su voz es como un eco en la oscuridad.";
    private static final String EL_GOBLIN_DEL_TUTORIAL_3_3 = "\"Tu destino ya está sellado... No puedes detener lo inevitable.\"";
    private static final String EL_GOBLIN_DEL_TUTORIAL_3_4 = "Antes de poder reaccionar, una energía oscura te envuelve. Es un portal, y sin poder evitarlo, caes en la negrura.";
    private static final String EL_GOBLIN_DEL_TUTORIAL_3_5 = "Despiertas en un lugar desconocido. Un gran salón de piedra se extiende ante ti, iluminado por antorchas de fuego violeta. "
            +
            "En un trono elevado, el goblin que creíste haber vencido te observa con una sonrisa burlona.";

    private static final String EL_GOBLIN_DEL_TUTORIAL_3_6 = "\"Bienvenido a nuestro dominio. Has demostrado ser fuerte… pero aún no eres digno.\"";

    private static final String EL_GOBLIN_DEL_TUTORIAL_3_7 = "A su alrededor, cinco figuras colosales lo observan. \n" +
    ...
    private static final String EL_GOBLIN_DEL_TUTORIAL_3_8 = "El goblin se levanta de su trono y avanza hacia ti. \n" +
    ...
    private static final String EL_GOBLIN_DEL_TUTORIAL_3_9 = "Uno de los miembros del Concilio se inclina ligeramente.";

    private static final String EL_GOBLIN_DEL_TUTORIAL_3_10 = "\"Él es el soberano de las plagas, y tú lo has desafiado sin siquiera entender su verdadero poder. Pero esto es solo el inicio.\"";

    private static final String EL_GOBLIN_DEL_TUTORIAL_3_11 = "El goblin extiende una garra y una nube de insectos letales se lanza contra ti. \n"
            +
    ...
    private static final String EL_GOBLIN_DEL_TUTORIAL_3_12 = "\"Veremos cuánto tiempo logras sobrevivir...\"";

    private static final String EL_GOBLIN_DEL_TUTORIAL_4_1 = "En tu viaje, los rumores te llevan a una caverna infestada de criaturas abominables. \n"
            +
            "Dentro, un aura oscura late con una presencia aterradora. Lo sabes de inmediato: el Monarca de los Bichos está aquí.";
    private static final String EL_GOBLIN_DEL_TUTORIAL_4_2 = "Al adentrarte, las paredes están cubiertas de colmenas y capullos retorcidos. \n"
            +
            "Cada paso que das parece alertar a la misma cueva, y antes de que puedas reaccionar, una sombra emerge de la penumbra.";
    private static final String EL_GOBLIN_DEL_TUTORIAL_4_3 = "El goblin ha evolucionado. Su cuerpo ahora es una amalgama de quitina y sombras, y sus ojos brillan con un hambre depredadora.";
    private static final String EL_GOBLIN_DEL_TUTORIAL_4_4 = "\"Huiste... pero nunca podrás escapar de mí. ¡Ahora serás devorado por la plaga!\"";
    private static final String EL_GOBLIN_DEL_TUTORIAL_4_5 = "La batalla comienza. \nÉl invoca enjambres de insectos para bloquear tus ataques, su velocidad ha aumentado, y cada golpe suyo parece liberar una nueva horda de criaturas. La cueva misma lucha contra ti.";
    private static final String EL_GOBLIN_DEL_TUTORIAL_4_5_VICTORIA = "Con esfuerzo y estrategia, logras romper su defensa. Un golpe certero atraviesa su pecho. Por primera vez, el Monarca de los Bichos cae.";
    private static final String EL_GOBLIN_DEL_TUTORIAL_4_5_DERROTA = "El enjambre está por todo tu cuerpo, se mete por tus ojos, boca, nariz, hasta llegar a todas las entrañas de tu cuerpo. \n"
            +
    ...
    private static final String EL_GOBLIN_DEL_TUTORIAL_4_6 = "Mientras su cuerpo se retuerce en espasmos, las criaturas que lo rodeaban se desmoronan. El silencio cae en la caverna. \n"
            +
            "Entonces, la voz de los otros miembros del Concilio resuena en tu mente.";
    private static final String EL_GOBLIN_DEL_TUTORIAL_4_7 = "\"El trono ha quedado vacío. Alguien debe ocuparlo.\"";
    private static final String EL_GOBLIN_DEL_TUTORIAL_4_8 = "Sientes una energía oscura fluir hacia ti. No hay elección. \n"
            +
